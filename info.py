...
API_ID = int(environ.get('API_ID', '1766888'))
API_HASH = environ.get('API_HASH', '38fd5547b63e8baa123658a63cdbaa68')
BOT_TOKEN = environ.get('BOT_TOKEN', "5968428592:AAEAn_I7HuiQ086UIeo1c7b1gm5ECFMigPY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '851193467').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001747343958).split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://thangarajm63:filter@cluster0.nl3bfn7.mongodb.net/?retryWrites=true&w=majority")
